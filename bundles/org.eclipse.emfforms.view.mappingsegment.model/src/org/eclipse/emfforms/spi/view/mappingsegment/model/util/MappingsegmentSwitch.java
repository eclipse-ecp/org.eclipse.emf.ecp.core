...
public class MappingsegmentSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		...
		case VMappingsegmentPackage.DMR_MAPPING_SEGMENT: {
			final VDMRMappingSegment dmrMappingSegment = (VDMRMappingSegment) theEObject;
			T result = caseDMRMappingSegment(dmrMappingSegment);
			if (result == null) {
				result = caseDMRSegment(dmrMappingSegment);
			}
			if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DMR Mapping Segment</em>'.
	 * <!-- begin-user-doc -->
	 ...
	 * @return the result of interpreting the object as an instance of '<em>DMR Mapping Segment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDMRMappingSegment(VDMRMappingSegment object)
	{
		return null;
	}
