 ...
 * {@link org.eclipse.emf.ecp.view.spi.indexdmr.model.VIndexDomainModelReferenceSegment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
...
public class IndexDomainModelReferenceSegmentItemProvider extends FeatureDomainModelReferenceSegmentItemProvider {
	...
	protected void addIndexPropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				...
				VIndexdmrPackage.Literals.INDEX_DOMAIN_MODEL_REFERENCE_SEGMENT__INDEX,
				true,
				false,
				false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_IndexDomainModelReferenceSegment_type") : //$NON-NLS-1$
			label + String.format("[%d]", index); //$NON-NLS-1$
	}
