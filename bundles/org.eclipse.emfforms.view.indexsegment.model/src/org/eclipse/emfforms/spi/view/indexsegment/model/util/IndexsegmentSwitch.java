...
public class IndexsegmentSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		...
		case VIndexsegmentPackage.DMR_INDEX_SEGMENT: {
			final VDMRIndexSegment dmrIndexSegment = (VDMRIndexSegment) theEObject;
			T result = caseDMRIndexSegment(dmrIndexSegment);
			if (result == null) {
				result = caseDMRSegment(dmrIndexSegment);
			}
			if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>DMR Index Segment</em>'.
	 * <!-- begin-user-doc -->
	 ...
	 * @return the result of interpreting the object as an instance of '<em>DMR Index Segment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDMRIndexSegment(VDMRIndexSegment object)
	{
		return null;
	}
