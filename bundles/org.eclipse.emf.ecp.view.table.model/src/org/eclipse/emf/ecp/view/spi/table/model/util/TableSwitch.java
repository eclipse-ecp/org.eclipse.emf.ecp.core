...
public class TableSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VTablePackage.SINGLE_COLUMN_CONFIGURATION: {
			VSingleColumnConfiguration singleColumnConfiguration = (VSingleColumnConfiguration) theEObject;
		...
		case VTablePackage.ENABLEMENT_CONFIGURATION: {
			VEnablementConfiguration enablementConfiguration = (VEnablementConfiguration) theEObject;
