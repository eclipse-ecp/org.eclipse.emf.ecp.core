 ...
 *
 */
public class EMFFormsDMRSegmentExpanderMapping_ITest {

	@Test
	public void testServiceRegistrationAndType() throws InvalidSyntaxException {
		final BundleContext bundleContext = FrameworkUtil.getBundle(EMFFormsDMRSegmentExpanderMapping_ITest.class)
			.getBundleContext();
		...
		for (final ServiceReference<EMFFormsDMRSegmentExpander> curRef : serviceReferences) {
			...
			if (EMFFormsDMRSegmentExpanderMapping.class.isInstance(curService)) {
