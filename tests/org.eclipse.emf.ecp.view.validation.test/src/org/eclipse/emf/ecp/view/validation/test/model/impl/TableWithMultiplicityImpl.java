 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ecp.view.validation.test.model.impl.TableWithMultiplicityImpl#getContent <em>Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableWithMultiplicityImpl extends EObjectImpl implements TableWithMultiplicity {
	...
	public EList<TableContent> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<TableContent>(TableContent.class, this, TestPackage.TABLE_WITH_MULTIPLICITY__CONTENT);
		}
		return content;
	}
