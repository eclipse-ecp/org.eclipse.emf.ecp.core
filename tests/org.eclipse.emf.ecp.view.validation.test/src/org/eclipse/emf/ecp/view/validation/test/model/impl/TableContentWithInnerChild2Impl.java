 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ecp.view.validation.test.model.impl.TableContentWithInnerChild2Impl#getInnerChild <em>Inner Child</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableContentWithInnerChild2Impl extends TableContentImpl implements TableContentWithInnerChild2 {
	...
	public NotificationChain basicSetInnerChild(TableContent newInnerChild, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TestPackage.TABLE_CONTENT_WITH_INNER_CHILD2__INNER_CHILD, oldInnerChild, newInnerChild);
	...
	public void setInnerChild(TableContent newInnerChild) {
		if (newInnerChild != innerChild) {
			...
			if (innerChild != null)
				msgs = ((InternalEObject)innerChild).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TestPackage.TABLE_CONTENT_WITH_INNER_CHILD2__INNER_CHILD, null, msgs);
			if (newInnerChild != null)
				msgs = ((InternalEObject)newInnerChild).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TestPackage.TABLE_CONTENT_WITH_INNER_CHILD2__INNER_CHILD, null, msgs);
			msgs = basicSetInnerChild(newInnerChild, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.TABLE_CONTENT_WITH_INNER_CHILD2__INNER_CHILD, newInnerChild, newInnerChild));
	}
