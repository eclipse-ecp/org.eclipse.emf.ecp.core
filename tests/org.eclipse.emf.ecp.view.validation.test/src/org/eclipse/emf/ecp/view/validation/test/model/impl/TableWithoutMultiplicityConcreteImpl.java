 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.ecp.view.validation.test.model.impl.TableWithoutMultiplicityConcreteImpl#getContent <em>Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableWithoutMultiplicityConcreteImpl extends EObjectImpl implements TableWithoutMultiplicityConcrete {
	...
	public EList<TableContentWithInnerChild> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<TableContentWithInnerChild>(TableContentWithInnerChild.class, this, TestPackage.TABLE_WITHOUT_MULTIPLICITY_CONCRETE__CONTENT);
		}
		return content;
	}
