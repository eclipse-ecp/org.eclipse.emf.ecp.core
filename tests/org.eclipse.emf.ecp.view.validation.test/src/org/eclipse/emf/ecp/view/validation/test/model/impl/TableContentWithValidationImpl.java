 ...
 *   <li>{@link org.eclipse.emf.ecp.view.validation.test.model.impl.TableContentWithValidationImpl#getWeight <em>Weight</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TableContentWithValidationImpl extends TableContentImpl implements TableContentWithValidation {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.TABLE_CONTENT_WITH_VALIDATION__NAME, oldName, name));
	}
	...
	public void setWeight(int newWeight) {
		...
		weight = newWeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestPackage.TABLE_CONTENT_WITH_VALIDATION__WEIGHT, oldWeight, weight));
	}
