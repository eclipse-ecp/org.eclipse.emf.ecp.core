...
/**
 * JUnit integration test cases for {@link StructuralChangeSegmentTesterMapping}.
 *
 * @author Lucas Koehler
 *
 */
public class StructuralChangeSegmentTesterMapping_ITest {
	...
	public static void setUpBeforeClass() {
		bundleContext = FrameworkUtil.getBundle(StructuralChangeSegmentTesterMapping_ITest.class).getBundleContext();
	}
	...
	public void testServiceType() {
		assertTrue(StructuralChangeSegmentTesterMapping.class.isInstance(service));
	}
	...
	public void testIntegration() throws DatabindingFailedException {
		...
		final StructuralChangeSegmentTesterMapping changeTester = (StructuralChangeSegmentTesterMapping) service;
