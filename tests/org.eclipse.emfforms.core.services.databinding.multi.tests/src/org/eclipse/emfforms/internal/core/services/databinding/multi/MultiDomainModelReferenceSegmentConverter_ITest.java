...
/**
 * All JUnit integration tests for {@link MultiDomainModelReferenceSegmentConverter}.
 *
 * @author Lucas Koehler
 *
 */
public class MultiDomainModelReferenceSegmentConverter_ITest {

	@Test
	public void testServiceRegistrationAndType() throws InvalidSyntaxException {
		final BundleContext bundleContext = FrameworkUtil
			.getBundle(MultiDomainModelReferenceSegmentConverter_ITest.class)
			.getBundleContext();
		...
		for (final ServiceReference<DomainModelReferenceSegmentConverterEMF> curRef : serviceReferences) {
			...
			if (MultiDomainModelReferenceSegmentConverter.class.isInstance(curService)) {
