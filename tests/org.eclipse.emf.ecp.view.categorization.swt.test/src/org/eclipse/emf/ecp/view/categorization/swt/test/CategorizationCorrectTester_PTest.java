...
public class CategorizationCorrectTester_PTest {
	...
	public void testCorrectTesterForCategorizationWithDepth0() {
		...
		final double applicable = tabTester.isApplicable(categorizationElement, viewModelContext);
		...
		final double applicableTree = treeTester.isApplicable(categorizationElement, viewModelContext);
	...
	public void testCorrectTesterForCompositeCategoryWithDepth0() {
		...
		final double applicable0 = defaultTester.isApplicable(categorization0, viewModelContext);
		assertEquals(1, applicable0, 0d);

		final double applicableTab0 = tabTester.isApplicable(categorization0, viewModelContext);
		assertEquals(EMFFormsRendererService.NOT_APPLICABLE, applicableTab0, 0d);

		final double applicableTree0 = treeTester.isApplicable(categorization0, viewModelContext);
		assertEquals(EMFFormsRendererService.NOT_APPLICABLE, applicableTree0, 0d);

		final double applicable1 = defaultTester.isApplicable(categorization1, viewModelContext);
		assertEquals(1, applicable1, 0d);

		final double applicableTab1 = tabTester.isApplicable(categorization1, viewModelContext);
		assertEquals(EMFFormsRendererService.NOT_APPLICABLE, applicableTab1, 0d);

		final double applicableTree1 = treeTester.isApplicable(categorization1, viewModelContext);
		assertEquals(EMFFormsRendererService.NOT_APPLICABLE, applicableTree1, 0d);

		final double applicable2 = defaultTester.isApplicable(categorization2, viewModelContext);
		assertEquals(1, applicable2, 0d);

		final double applicableTab2 = tabTester.isApplicable(categorization2, viewModelContext);
		assertEquals(EMFFormsRendererService.NOT_APPLICABLE, applicableTab2, 0d);

		final double applicableTree2 = treeTester.isApplicable(categorization2, viewModelContext);
		assertEquals(EMFFormsRendererService.NOT_APPLICABLE, applicableTree2, 0d);

		final double applicable3 = defaultTester.isApplicable(categorization3, viewModelContext);
		assertEquals(1, applicable3, 0d);

		final double applicableTab3 = tabTester.isApplicable(categorization3, viewModelContext);
		assertEquals(EMFFormsRendererService.NOT_APPLICABLE, applicableTab3, 0d);

		final double applicableTree3 = treeTester.isApplicable(categorization3, viewModelContext);
