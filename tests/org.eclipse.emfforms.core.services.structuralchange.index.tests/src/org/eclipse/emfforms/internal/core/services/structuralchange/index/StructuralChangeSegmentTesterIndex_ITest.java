...
/**
 * JUnit integration tests for {@link StructuralChangeSegmentTesterIndex}.
 *
 * @author Lucas Koehler
 *
 */
public class StructuralChangeSegmentTesterIndex_ITest {
	...
	public static void setUpBeforeClass() {
		bundleContext = FrameworkUtil.getBundle(StructuralChangeSegmentTesterIndex_ITest.class).getBundleContext();
	}
	...
	public void testServiceType() {
		assertTrue(StructuralChangeSegmentTesterIndex.class.isInstance(service));
	}
	...
	public void testIntegration() throws DatabindingFailedException {
		...
		final StructuralChangeSegmentTesterIndex changeTester = (StructuralChangeSegmentTesterIndex) service;
